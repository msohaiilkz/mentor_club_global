...
export const DeXaLayers = [
  ...
  },
  {
    ...
    desc: "Applies AI models for understanding, reasoning, classification, extraction, and generation. Combines language understanding with domain-specific reasoning to produce contextually relevant responses and decisions.",
  },
  {
    name: "Knowledge and Domain Layer",
    desc: "Retrieves information from approved knowledge bases, SOPs, policy documents, benefit rules, insurance rules, finance rules, regulatory materials, and client-specific content using RAG and structured retrieval.",
  },
  {
    name: "Orchestration Layer",
    desc: "Coordinates multi-agent workflows, routes tasks to specialist agents, manages agent collaboration, handles retries and failures, and ensures complex multi-step operations are completed reliably.",
  },
  {
    name: "Execution Layer",
    desc: "Triggers approved actions including system updates, document processing, notification delivery, ticket creation, payment status changes, portal updates, and workflow state transitions.",
  },
  {
    name: "Monitoring and Feedback Layer",
    desc: "Tracks agent health, response quality, confidence scores, failure rates, escalation rates, user feedback, costs, and system performance. Feeds improvements back into knowledge, rules, and model evaluation.",
  },
];
...
export const DeXaPillars = [
  {
    ...
    items: [
      ...
      "HR support",
      "Claims team summaries",
      "Escalation routing",
    ],
  },
  {
    name: "Insurance AI Infrastructure",
    items: [
      "Quote intake",
      "Broker guidance",
      "Risk discovery",
  ...
  {
    name: "Fintech AI Infrastructure",
    items: [
      "Wallet explanation",
  ...
  {
    name: "Mentor OS AI Infrastructure",
    items: [
      "CRM intelligence",
      "PRM intelligence",
      "Task guidance",
  ...
  {
    name: "HealthRails AI Infrastructure",
    items: [
      "Idea intake",
...
export const agentGroups = [
  {
    ...
    agents: [
      {
        name: "Intro Agent",
        desc: "First-touch intelligence that captures founder or client intent, understands the problem space, and gathers initial context for product creation.",
      },
      {
        name: "Recommendation Model",
        desc: "Analyzes the idea against existing modules, market patterns, and technology capabilities to suggest optimal product direction and architecture.",
      },
      {
        name: "Technical Discovery Agent",
        desc: "Collects detailed technical requirements, identifies integration needs, maps user roles, defines workflows, and structures the complete product scope.",
      },
    ],
  },
  {
    ...
    agents: [
      {
        ...
        desc: "Coordinates frontend, backend, API, database, and workflow development tasks based on approved scope and technical specifications.",
      },
      {
        name: "Tester Deployer Agent",
        desc: "Executes testing workflows, identifies bugs, validates functionality, and manages deployment pipelines with human approval gates.",
      },
      {
    ...
    agents: [
      {
        ...
        desc: "Supports compliance documentation, business registration preparation, legal document drafting, and regulatory requirement identification.",
      },
      {
        name: "Digital Marketer Agent",
        desc: "Creates marketing content, social media plans, launch strategies, and customer acquisition frameworks based on product context.",
      },
      {
        name: "Design Engine AI",
        desc: "Generates UI/UX designs, brand assets, visual systems, and interface layouts aligned with product requirements and brand guidelines.",
      },
    ],
  },
];
...
export const aiScenarios = [
  {
    ...
    approval: {
      role: "Claims Officer",
      action: "Review prescription for approval",
    },
  },
  {
    ...
    approval: {
      ...
      action: "Authorize manual risk assessment",
    },
  },
  {
    ...
    approval: {
      ...
      action: "Approve settlement exception correction",
    },
  },
  {
    domain: "Mentor OS leadership",
    userRole: "CEO",
    ...
    approval: {
      role: "COO",
      action: "Validate and approve corrective action plan",
    },
  },
  {
    domain: "HealthRails software creation",
    userRole: "Founder",
    question:
    ...
    approval: {
      ...
      action: "Approve product scope and technical architecture",
    },
  },
];
...
export const aiDeploymentModels = [
  ...
  },
  {
    ...
    desc: "Multi-agent coordination infrastructure for complex workflows across domains.",
  },
  {
    name: "AI governance layer",
    desc: "Governance infrastructure providing audit, monitoring, approval gates, and compliance controls.",
  },
  {
  ...
  },
  {
    ...
    desc: "Custom knowledge bases, rules, and configurations deployed per client organization.",
  },
  {
    name: "Domain specific AI deployment",
    desc: "Specialized AI infrastructure for healthcare, insurance, fintech, or operating system domains.",
  },
  {
    name: "Human controlled deployment",
    desc: "Deployment with strict human approval gates for all critical actions and decisions.",
  },
];

export const aiUseCases = [
  {
    name: "Healthcare claims intelligence",
    who: "Claims teams",
    problem: "Manual claim review and document checking",
    rail: "Knowledge + Rules + Workflow",
    approval: "Claims team approval before settlement",
  },
  {
    name: "Employee benefit guidance",
    who: "Employees",
    problem: "Unclear benefit rules and coverage",
    rail: "Knowledge + Context + Rules",
    approval: "Escalation to HR for complex queries",
  },
  {
    name: "Provider navigation assistant",
    who: "Employees",
    problem: "Finding the right provider",
    rail: "Knowledge + Context",
    approval: "No approval needed for information queries",
  },
  {
    name: "Insurance quote intake",
    who: "Customers and brokers",
    problem: "Complex quote requirements",
    rail: "Context + Workflow + Agent",
    approval: "Underwriter review for high-risk cases",
  },
  {
    name: "Underwriting summary engine",
    who: "Underwriters",
    problem: "Manual risk assessment compilation",
    rail: "Knowledge + Rules + Agent",
    approval: "Underwriter final decision",
  },
  {
    name: "Broker workflow assistant",
    who: "Brokers",
    problem: "Managing multiple workflows",
    rail: "Context + Workflow + Tools",
    approval: "Broker confirms all client actions",
  },
  {
    name: "Reinsurance summary assistant",
    who: "Reinsurance teams",
    problem: "Complex treaty and exposure analysis",
    rail: "Knowledge + Rules",
    approval: "Senior review for exposure decisions",
  },
  {
    name: "Wallet and payment support",
    who: "Employees and providers",
    problem: "Payment failures and wallet confusion",
    rail: "Context + Rules + Tools",
    approval: "Finance approval for exceptions",
  },
  {
    name: "Reconciliation exception assistant",
    who: "Finance teams",
    problem: "Manual exception investigation",
    rail: "Knowledge + Rules + Monitoring",
    approval: "Finance team approval for settlements",
  },
  {
    name: "Payroll exception assistant",
    who: "HR and finance",
    problem: "Failed validations and pending approvals",
    rail: "Rules + Workflow + Tools",
    approval: "Maker-checker for payroll actions",
  },
  {
    name: "Corporate expense policy assistant",
    who: "Employees and managers",
    problem: "Policy confusion and violations",
    rail: "Knowledge + Rules",
    approval: "Manager approval for exceptions",
  },
  {
    name: "Mentor OS leadership assistant",
    who: "CEOs and leaders",
    problem: "Scattered operational visibility",
    rail: "Context + Knowledge + Monitoring",
    approval: "Leadership validates action plans",
  },
  {
    name: "Work Intelligence engine",
    who: "All employees",
    problem: "Low productivity visibility",
    rail: "Monitoring + Feedback",
    approval: "Manager reviews recommendations",
  },
  {
    name: "HealthRails product discovery",
    who: "Founders and clients",
    problem: "Turning ideas into structured products",
    rail: "Agent + Workflow + Knowledge",
    approval: "Human validates scope before build",
  },
  {
    name: "AI assisted software generation",
    who: "Development teams",
    problem: "Slow manual development",
    rail: "Agent + Workflow + Tools",
    approval: "Human deployment approval required",
  },
  {
    name: "White labelled client AI assistant",
    who: "Client platform users",
    problem: "No intelligent guidance layer",
    rail: "All Rails",
    approval: "Client-specific approval rules",
  },
];
