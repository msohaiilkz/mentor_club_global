...
export default function Navbar() {
  ...
  return (
    <nav
      ...
      className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-300 ${navBg} border-b ${borderColor}`}
    >
      <div className="max-w-[1720px] mx-auto px-6 md:px-12">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link
            ...
            className="hidden lg:inline-flex items-center gap-2 px-4 py-2 md:px-5 md:py-2.5 bg-[#0048FF] text-white text-xs md:text-sm font-semibold hover:bg-[#0030CC] transition-colors whitespace-nowrap"
          >
            Partner With Us <ArrowRight className="w-3.5 md:w-4 h-3.5 md:h-4" />
          </Link>
