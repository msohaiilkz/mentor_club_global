  ...
  return (
    <div className="relative w-full aspect-square max-w-[700px] flex items-center justify-center perspective-[2000px]">
      ...
      <div className="relative w-[90%] h-[90%] preserve-3d">
        ...
        >
          <div className="w-full h-full bg-white/[0.04] backdrop-blur-xl border border-white/20 shadow-[0_30px_60px_rgba(0,0,0,0.4)] p-4 sm:p-6 lg:p-8 flex flex-col justify-between group overflow-hidden relative">
        ...
        >
          <div className="w-full h-full bg-[#0048FF]/10 backdrop-blur-2xl border border-[#0048FF]/40 shadow-[0_30px_70px_rgba(0,72,255,0.2)] p-4 sm:p-6 lg:p-8 flex flex-col justify-between group overflow-hidden relative">
        ...
        >
          <div className="w-full h-full bg-white/[0.02] backdrop-blur-md border border-white/10 p-4 sm:p-6 lg:p-8 flex flex-col justify-between relative overflow-hidden">
            <div
...
function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute -bottom-[20%] -left-[10%] w-[320px] h-[320px] sm:w-[560px] sm:h-[560px] lg:w-[800px] lg:h-[800px] rounded-full bg-[#0048FF]/[0.03] blur-[150px]" />
