...
const DeXaDomains = [
  ...
  },
  {
    name: "HealthRails",
    items: [
      "Studio workflow control",
      "Compose orchestration",
      "Runtime supervision",
      "AI agent assignment",
      "Testing and deployment",
      "KYC and design operations",
    ],
  },
  {
    name: "Mentor OS",
    items: [
      "Work Intelligence",
      "Daily employee guidance",
      "Leadership AI Window",
...
const agentPods = [
  {
    name: "Intro Agent",
    desc: "First-touch intelligence for user onboarding and context gathering.",
  },
  {
    name: "Recommendation Model",
    desc: "AI-driven recommendations for products, providers, and plans.",
  },
  {
    name: "Technical Discovery Agent",
    desc: "Deep technical analysis for platform integration and architecture.",
  },
  {
    name: "Full Stack Development Agent",
    desc: "AI-assisted development, code generation, and platform building.",
  },
  {
    name: "Tester Deployer Agent",
    desc: "Automated testing, quality assurance, and deployment intelligence.",
  },
  {
    name: "KYC Lawyer Agent",
    desc: "Compliance verification, regulatory checks, and legal document processing.",
  },
  {
    name: "Digital Marketer Agent",
    desc: "Marketing intelligence, campaign optimization, and growth analytics.",
  },
  {
    name: "Design Engine AI",
    desc: "UI/UX intelligence, design system management, and visual optimization.",
  },
];
...
const governance = [
  {
    ...
    desc: "Critical decisions require human review and approval before execution.",
  },
  {
    title: "Audit Trails",
    desc: "Every action, recommendation, and decision is logged and traceable.",
  },
  {
    title: "Confidence Scoring",
    desc: "Each output includes a confidence score for transparency and trust.",
  },
  {
    title: "Domain Boundaries",
    desc: "DeXa operates within defined domain boundaries and escalates edge cases.",
  },
];
          ...
          <div>
            ...
            <ScrollReveal delay={0.15}>
              <p className="text-lg text-[#8A8A93] leading-relaxed max-w-xl">
                DeXa is not a surface layer interface. It is a governed
                processing engine that connects user intent with approved
                knowledge, deterministic rules, and agentic execution.
              </p>
            </ScrollReveal>
            <ScrollReveal delay={0.25}>
              <div className="mt-10 space-y-6">
                {[
                  {
                    label: "Understand",
                    desc: "Identifies role, intent, and system context.",
                  },
                  {
                    label: "Reason",
                    desc: "Applies rules and retrieves approved knowledge.",
                  },
                  {
                    label: "Act",
                    desc: "Coordinates agents and updates system states.",
                  },
                  {
                    label: "Govern",
                    desc: "Logs actions and escalates for human approval.",
                  },
                ].map((step, i) => (
                  <div key={step.label} className="flex gap-4">
                    <div className="w-1.5 h-1.5 bg-[#0048FF] mt-2 shrink-0" />
                    <div>
                      <p className="text-base font-bold text-white uppercase tracking-widest mb-1">
                        {step.label}
                      </p>
            ...
            <div>
              <ScrollReveal>
                ...
                <h1 className="text-[var(--fs-hero)] font-bold text-white tracking-tighter leading-[1.05]">
                  DeXa, The Intelligence Processing Engine Behind Mentor
                  Global
                </h1>
              </ScrollReveal>
              <ScrollReveal delay={0.15}>
                <p className="mt-8 text-lg md:text-xl text-[#8A8A93] max-w-xl leading-relaxed">
                  DeXa powers intelligent operations across healthcare,
                  insurance, fintech, HealthRails, Mentor OS, and white labelled
                  client platforms.
                </p>
              </ScrollReveal>
            </div>
              ...
              <ScrollReveal>
                ...
                <div className="space-y-4">
                  {whatDeXaIsNot.map((item) => (
                    <p
                      key={item}
                      className="text-base md:text-lg font-semibold text-[#11111F]/60"
                    >
                      {item}
                    </p>
                  ))}
          ...
          <div className="border border-white/10">
            {DeXaDomains.map((domain, i) => (
              <ScrollReveal key={domain.name} delay={i * 0.08}>
                <div
                  className={`grid grid-cols-1 md:grid-cols-12 ${i > 0 ? "border-t border-white/10" : ""}`}
                >
                  ...
                  <div className="md:col-span-8 p-6 md:p-8">
                    <div className="flex flex-wrap gap-3">
                      {domain.items.map((item) => (
                        <span
                          key={item}
                          className="text-base text-[#8A8A93] px-3 py-1 border border-white/10"
                        >
                          {item}
                        </span>
                      ))}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <ScrollReveal>
            ...
            <p className="text-base text-[#666666] leading-relaxed max-w-3xl mb-12">
              HealthRails provides the platform architecture. DeXa provides
              the intelligence that operates it. DeXa controls Studio,
              Compose, and Runtime workflows, assigns work to specialized AI
              agents, and supervises testing, deployment, KYC, design, and
