...
const MoneyMovementArchitecture = () => {
  ...
  return (
    <div className="relative w-full h-[480px] sm:h-[560px] lg:h-[600px] flex items-center justify-center font-sans">
      ...
      >
        <div className="relative w-full h-full bg-[#080810] flex items-center justify-center p-4 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full px-4 sm:px-6 lg:px-8 items-center relative z-10 mt-12 mb-10 h-[calc(100%-100px)]">
            ...
            <div className="col-span-1 lg:col-span-6 relative flex flex-col items-center">
              {/* Connection Lines from Sources */}
              <div className="absolute -left-full w-full h-full pointer-events-none z-0 hidden lg:block">
                <motion.div
              ...
              <div className="absolute -right-full w-full h-full pointer-events-none z-0 hidden lg:block">
                <motion.div
                  animate={{ x: [0, 400], opacity: [0, 1, 0] }}
                  transition={{
                    duration: 2.5,
