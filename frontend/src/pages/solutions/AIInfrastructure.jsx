          ...
          <div>
            ...
            <ScrollReveal delay={0.15}>
              <p className="mt-8 hero-desc">
                Deploy governed intelligence infrastructure that understands
                context, connects to systems, coordinates agents, routes
                workflows, monitors execution, and powers decision support
                across healthcare, insurance, fintech, HealthRails, Mentor OS,
                and client platforms.
              </p>
            </ScrollReveal>
            <ScrollReveal delay={0.25}>
              <p className="mt-4 text-base text-[#8A8A93]/70 max-w-xl">
                Mentor Global does not add AI as a surface feature. It builds
                governed intelligence infrastructure that connects knowledge,
                rules, workflows, agents, APIs, approvals, and auditability into
                one operating layer.
              </p>
            </ScrollReveal>
            <ScrollReveal delay={0.35}>
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <Link
                  to="/contact"
                  data-testid="ai-hero-cta"
                  className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 md:px-8 py-3 sm:py-4 bg-[#0048FF] text-white font-semibold hover:bg-[#0030CC] transition-all hover:scale-105 active:scale-95 shadow-lg shadow-[#0048FF]/20"
                >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <ScrollReveal>
          ...
          <h2 className="text-[30px] sm:text-[28px] md:text-[36px] lg:text-[42px] xl:text-[48px] font-bold text-[#11111F] tracking-tight max-w-4xl">
            Most AI fails because it is disconnected from operations.
          </h2>
        </ScrollReveal>
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12">
        <ScrollReveal>
          ...
          <h2 className="text-[30px] sm:text-[28px] md:text-[36px] lg:text-[42px] xl:text-[48px] font-bold text-white tracking-tight max-w-4xl">
            One AI infrastructure stack. Multiple intelligence rails.
          </h2>
        </ScrollReveal>
        <div className="mt-16 space-y-[1px]">
          {aiRails.map((rail, idx) => (
  ...
  return (
    <section data-testid="ai-rails-visual" className="bg-white py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
        <ScrollReveal>
          <p className="eyebrow mb-4">Connected Intelligence</p>
          <h2 className="text-[30px] sm:text-[28px] md:text-[36px] lg:text-[42px] xl:text-[48px] font-bold text-[#11111F] tracking-tight mb-16">
            From isolated AI tools to one governed intelligence layer
          </h2>
        </ScrollReveal>
        <ScrollReveal delay={0.1}>
          <div className="mx-auto w-64 md:w-80 py-5 bg-[#11111F] text-white text-center mb-6">
            <p className="text-sm font-bold">DeXa Intelligence Engine</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-5 border border-[#11111F]/10">
            {aiRails.map((rail) => (
              <div
                key={rail.name}
                className="p-3 md:p-4 text-center card-hover border-r border-b border-[#11111F]/10"
              >
                <div className="w-2 h-2 bg-[#0048FF] mx-auto mb-2" />
                <p className="text-xs md:text-sm font-bold text-[#11111F]">
          ...
          <p className="mt-5 text-sm text-[#666666]">
            ...
            Deployed through{" "}
            <span className="font-bold text-[#11111F]">Mentor Global</span>{" "}
            infrastructure.
          </p>
        </ScrollReveal>
      </div>
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12">
        <ScrollReveal>
          ...
          <h2 className="text-[30px] sm:text-[28px] md:text-[36px] lg:text-[42px] xl:text-[48px] font-bold text-white tracking-tight max-w-4xl">
            DeXa is the intelligence processing engine inside Mentor Global
          </h2>
        </ScrollReveal>
        <ScrollReveal delay={0.1}>
          <p className="mt-6 text-base text-[#8A8A93] max-w-3xl leading-relaxed">
            DeXa receives structured and unstructured inputs, understands
            user and system context, retrieves approved knowledge, applies
            rules, coordinates agents, routes workflows, triggers approved
            actions, monitors execution, and escalates to humans when required.
          </p>
        </ScrollReveal>
        <div className="mt-12">
          <ScrollReveal delay={0.15}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-[1px] bg-white/10">
              {DeXaPrinciples.map((p, i) => (
                <div key={p} className="bg-[#11111F] p-4 card-hover-dark">
        ...
        <div className="mt-12">
          <ScrollReveal delay={0.2}>
            ...
            <div className="flex flex-wrap items-center gap-1">
              {DeXaPipeline.map((step, i) => (
                <span key={step} className="flex items-center gap-1">
                  <span className="text-sm px-3 py-1.5 bg-white/5 border border-white/10 text-white font-medium">
                    {step}
                  </span>
                  {i < DeXaPipeline.length - 1 && (
...
function FunctionalArchitecture() {
  return (
    <section
      data-testid="ai-functional-layers"
      className="bg-white py-24 md:py-32"
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <ScrollReveal>
          <p className="eyebrow mb-4">Functional Architecture</p>
          <h2 className="text-[30px] sm:text-[28px] md:text-[36px] lg:text-[42px] xl:text-[48px] font-bold text-[#11111F] tracking-tight">
            Six layers of DeXa intelligence
          </h2>
        </ScrollReveal>
        <div className="mt-16 border border-[#11111F]/10">
          {DeXaLayers.map((layer, idx) => (
            <ScrollReveal key={layer.name} delay={idx * 0.05}>
              <div
                className={`grid grid-cols-1 md:grid-cols-12 ${idx > 0 ? "border-t border-[#11111F]/10" : ""}`}
              >
                <div className="md:col-span-4 p-5 md:p-6 border-b md:border-b-0 md:border-r border-[#11111F]/10">
                  <span className="text-[#0048FF] text-sm font-bold">
                    L{idx + 1}
                  </span>
                  <p className="text-base font-bold text-[#11111F] mt-1">
                    {layer.name}
                  </p>
                </div>
...
function DeXaAcrossPillars() {
  return (
    <section data-testid="ai-pillars" className="bg-[#11111F] py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <ScrollReveal>
          <p className="eyebrow mb-4">Across Pillars</p>
          <h2 className="text-[30px] sm:text-[28px] md:text-[36px] lg:text-[42px] xl:text-[48px] font-bold text-white tracking-tight max-w-4xl">
            One intelligence engine across healthcare, insurance, fintech,
            HealthRails, and Mentor OS
          </h2>
        </ScrollReveal>
        <div className="mt-16 space-y-[1px]">
          {DeXaPillars.map((pillar, idx) => (
    ...
    <section data-testid="ai-agents" className="bg-white py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <ScrollReveal>
          ...
          <h2 className="text-[30px] sm:text-[28px] md:text-[36px] lg:text-[42px] xl:text-[48px] font-bold text-[#11111F] tracking-tight">
            Agentic AI pods coordinated by DeXa
          </h2>
        </ScrollReveal>
        <div className="mt-16 space-y-12">
          {agentGroups.map((group, gIdx) => (
            <ScrollReveal key={group.group} delay={gIdx * 0.08}>
              <div>
                <p className="text-sm uppercase tracking-[0.2em] font-bold text-[#0048FF] mb-4">
                  {group.group}
                </p>
    ...
    <section data-testid="ai-architecture" className="bg-white py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <ScrollReveal>
          ...
          <h2 className="text-[30px] sm:text-[28px] md:text-[36px] lg:text-[42px] xl:text-[48px] font-bold text-[#11111F] tracking-tight max-w-4xl">
            Built as AI infrastructure, not a chatbot layer
          </h2>
        </ScrollReveal>
        <div className="mt-16 border border-[#11111F]/10">
          {aiArchitectureLayers.map((layer, idx) => (
            <ScrollReveal key={layer.name} delay={idx * 0.03}>
              <div
                className={`grid grid-cols-1 md:grid-cols-12 ${idx > 0 ? "border-t border-[#11111F]/10" : ""}`}
              >
                <div className="md:col-span-3 p-4 md:p-5 border-b md:border-b-0 md:border-r border-[#11111F]/10">
                  <span className="text-[#0048FF] text-sm font-bold">
                    L{idx + 1}
                  </span>
                ...
                <div className="md:col-span-9 p-4 md:p-5">
                  <div className="flex flex-wrap gap-1.5">
                    {layer.items.map((item) => (
                      <span
                        key={item}
                        className="text-xs px-2 py-0.5 border border-[#11111F]/10 text-[#666666]"
                      >
                        {item}
                      </span>
                    ))}
    ...
    <section data-testid="ai-use-cases" className="bg-white py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <ScrollReveal>
          ...
          <h2 className="text-[30px] sm:text-[28px] md:text-[36px] lg:text-[42px] xl:text-[48px] font-bold text-[#11111F] tracking-tight max-w-4xl">
            AI infrastructure that can power multiple operating models
          </h2>
        </ScrollReveal>
          ...
          {aiUseCases.map((uc, i) => (
            <ScrollReveal key={uc.name} delay={i * 0.02}>
              <div className="bg-white p-5 card-hover h-full">
                <h3 className="text-base font-bold text-[#11111F] mb-2">
                  {uc.name}
                </h3>
                <div className="space-y-1 text-sm text-[#666666]">
                  ...
                  <p>
                    <span className="text-[#0048FF] font-bold">Problem:</span>{" "}
                    {uc.problem}
                  </p>
                  <p>
                  ...
                  <p>
                    <span className="text-[#0048FF] font-bold">Approval:</span>{" "}
                    {uc.approval}
                  </p>
                </div>
              </div>
    ...
    <section data-testid="ai-outcomes" className="bg-[#11111F] py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <ScrollReveal>
          ...
          <h2 className="text-[30px] sm:text-[28px] md:text-[36px] lg:text-[42px] xl:text-[48px] font-bold text-white tracking-tight">
            What AI infrastructure should deliver
          </h2>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.3}>
          <div className="mt-12 flex items-start gap-4 p-6 bg-white/[0.02] border-l-2 border-[#0048FF] max-w-4xl">
            <p className="text-[13px] text-[#8A8A93] leading-relaxed">
              ...
              Designed to improve operational visibility, support faster
              workflow routing, reduce repetitive manual coordination,
              strengthen governance, and support human controlled automation.
              These do not represent unsupported claims.
            </p>
          </div>
        </ScrollReveal>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
        <ScrollReveal>
          <h2 className="text-[30px] sm:text-[28px] md:text-[36px] lg:text-[42px] xl:text-[48px] font-bold text-[#11111F] tracking-tight max-w-4xl mx-auto">
            Build AI infrastructure that connects knowledge, rules, agents,
            workflows, approvals, and intelligence
          </h2>
        </ScrollReveal>
        <ScrollReveal delay={0.1}>
          <p className="mt-6 text-base text-[#666666] max-w-2xl mx-auto leading-relaxed">
            Mentor Global helps organizations move from isolated AI tools to
            governed intelligence infrastructure powered by DeXa, agent
            orchestration, RAG, rules engines, human approval gates, monitoring,
            audit logs, APIs, and workflow automation.
          </p>
        </ScrollReveal>
        <ScrollReveal delay={0.2}>
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              data-testid="ai-final-build-cta"
              className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 md:px-8 py-3 sm:py-4 bg-[#0048FF] text-white font-semibold hover:bg-[#0030CC] transition-colors"
            >
              Build AI Infrastructure <ArrowRight className="w-5 h-5" />
            </Link>
            <Link
              to="/DeXa"
              data-testid="ai-final-DeXa-cta"
              className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 md:px-8 py-3 sm:py-4 border border-[#11111F]/20 text-[#11111F] font-semibold hover:bg-[#11111F]/5 transition-colors"
            >
