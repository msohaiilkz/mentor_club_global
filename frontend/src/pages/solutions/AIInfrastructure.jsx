          ...
          <div>
            ...
            <ScrollReveal delay={0.35}>
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <Link to="/contact" data-testid="ai-hero-cta" className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 md:px-8 py-3 sm:py-4 bg-[#0048FF] text-white font-semibold hover:bg-[#0030CC] transition-all hover:scale-105 active:scale-95 shadow-lg shadow-[#0048FF]/20">
                  Build AI Infrastructure <ArrowRight className="w-5 h-5" />
                </Link>
                <Link to="/dexa" className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 md:px-8 py-3 sm:py-4 border border-white/20 text-white font-semibold hover:bg-white/5 transition-colors">
                  Explore DEXA
                </Link>
              </div>
            </ScrollReveal>
