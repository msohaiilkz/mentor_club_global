        ...
        <div className="max-w-[1720px] mx-auto px-6 md:px-12">
          <ScrollReveal>
            <Link
              ...
              className="inline-flex items-center gap-2 text-base text-[#666666] hover:text-[#0048FF] transition-colors mb-8"
            >
      ...
      <section className="bg-[#11111F] py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12">
          <ScrollReveal>
            ...
            <h2 className="text-[30px] sm:text-[28px] md:text-[36px] lg:text-[42px] xl:text-[48px] font-bold text-white tracking-tight max-w-3xl mb-16">
              ...
              {solution.agentPods.map((pod, i) => (
                <ScrollReveal key={pod} delay={i * 0.05}>
                  <div className="bg-[#11111F] p-6 md:p-8 card-hover-dark h-full">
                    ...
                    <p className="text-base font-medium text-white">{pod}</p>
                  </div>
                </ScrollReveal>
              ))}
            </div>
        ...
        <section className="bg-white py-24 md:py-32">
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <ScrollReveal>
              ...
              <h2 className="text-[30px] sm:text-[28px] md:text-[36px] lg:text-[42px] xl:text-[48px] font-bold text-[#11111F] tracking-tight mb-4">
      ...
      <section className="bg-[#11111F] py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#0048FF] text-white text-base font-semibold hover:bg-[#0030CC] transition-colors"
          >
