        ...
        <div className="max-w-[1720px] mx-auto px-6 md:px-10 flex overflow-x-auto hide-scrollbar scroll-smooth">
          {bottomCards.map((card, i) => (
            <Link
              key={i}
              to={`/solutions`}
              className="flex-1 min-w-[260px] sm:w-full p-6 lg:p-6 border-r border-white/10 last:border-r-0 hover:bg-white/5 transition-colors group cursor-pointer flex flex-col justify-start"
            >
              ...
              <h4 className="text-base text-sm text-white/80 leading-relaxed group-hover:text-white transition-colors">
                {card.title}
              </h4>
            </Link>
          ))}
          ...
          <ScrollReveal delay={0.15}>
            <div className="w-full relative px-2 md:px-0">
              ...
              <IpadMockup orientation="portrait" className="max-w-[480px]">
                <div className="w-full h-full bg-white relative flex flex-col items-center justify-center p-4 md:p-6 overflow-hidden">
                  <div className="scale-[0.85] sm:scale-90 md:scale-100 origin-center">
                    <ArchitectureDiagram />
                  </div>
                </div>
              </IpadMockup>
...
function Problem() {
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 w-[240px] h-[240px] sm:w-[360px] sm:h-[360px] lg:w-[500px] lg:h-[500px] rounded-full bg-[#0048FF]/[0.03] blur-[120px]" />
...
function DeXaSection() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 right-0 w-[240px] h-[240px] sm:w-[360px] sm:h-[360px] lg:w-[500px] lg:h-[500px] rounded-full bg-[#0048FF]/[0.04] blur-[140px]" />
      <div className="relative max-w-7xl mx-auto px-6 md:px-12">
        <ScrollReveal>
...
function InnovationSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-[260px] h-[260px] sm:w-[420px] sm:h-[420px] lg:w-[600px] lg:h-[600px] bg-[#0048FF]/[0.02] blur-[150px] rounded-full pointer-events-none" />
      <div className="absolute bottom-1/4 left-0 w-[220px] h-[220px] sm:w-[300px] sm:h-[300px] lg:w-[400px] lg:h-[400px] bg-[#8A2BE2]/[0.02] blur-[120px] rounded-full pointer-events-none" />
...
function ScaleSection() {
  return (
    ...
    >
      <div className="absolute top-0 right-0 w-[260px] h-[260px] sm:w-[420px] sm:h-[420px] lg:w-[600px] lg:h-[600px] bg-[#0048FF]/[0.04] blur-[150px] rounded-full" />
      <div className="absolute bottom-0 left-0 w-[220px] h-[220px] sm:w-[300px] sm:h-[300px] lg:w-[400px] lg:h-[400px] bg-[#0048FF]/[0.03] blur-[120px] rounded-full" />
      <div className="relative max-w-7xl mx-auto px-6 md:px-12">
        <ScrollReveal>
